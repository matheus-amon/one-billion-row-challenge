...
def build_weather_station_name_list():
    ...
    """
    station_names = []
    with open('./db/weather_stations.csv', 'r', encoding="utf-8") as file:
...
def build_test_data(weather_station_names, num_rows_to_create):
    ...
    try:
        with open("./db/measurements.txt", 'w', encoding="utf-8") as file:
    ...
    file_size = os.path.getsize("./db/measurements.txt")
    human_file_size = convert_bytes(file_size)
 
    print("Arquivo escrito com sucesso db/measurements.txt")
